  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,800|Montserrat:600,700,800|Oswald:500,600,700|Caveat:500,600,700|Inter:400,600,700&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
